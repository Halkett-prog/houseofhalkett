...
useEffect(() => {
 ...
 return (
   ...
   {/* Step 4: Material Selection (Split for better UX) */}
   <div className="step" id="step4">
     ...
     <div className="customization-note">
       <div className="customization-button" onClick={openGallery}>
     ...
     <div style={{ textAlign: 'center', margin: '20px 0' }}>
       <button onClick={showSampleRequest} style={{ background: '#A1A2A0' }}>
     ...
     <div className="navigation">
       <button onClick={() => previousStep(4)} className="secondary">Previous</button>
       <button onClick={() => nextStep(4)}>Next Step</button>
     </div>
   </div>
   ...
   <div className="step" id="step5">
     ...
     <div className="form-group">
       ...
       <button onClick={generateWalls} style={{ marginTop: '10px' }}>Configure Walls</button>
     </div>
     
     <div id="wallsContainer"></div>
     
     <div className="navigation">
       <button onClick={() => previousStep(5)} className="secondary">Previous</button>
       <button onClick={() => nextStep(5)} id="calculateBtn">Calculate</button>
     </div>
   </div>
...
<div className="results-actions">
 <button onClick={addToCart} style={{ background: '#34499E', width: '100%' }}>
   <svg style={{ width: '16px', height: '16px' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
<div style={{ marginTop: '15px', display: 'flex', gap: '10px' }}>
 <button onClick={generatePDF} style={{ flex: 1, background: 'transparent', border: '2px solid #232320', color: '#232320' }}>
 ...
 <button onClick={saveConfiguration} style={{ flex: 1, background: 'transparent', border: '2px solid #232320', color: '#232320' }}>
   <svg style={{ width: '14px', height: '14px' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
   ...
   Save
     ...
     <div style={{ marginTop: '15px', textAlign: 'center' }}>
       <p style={{ fontSize: '12px', color: '#A1A2A0', margin: '10px 0' }}>
         ...
         <a href="#" onClick={(event) => { event.preventDefault(); emailSpecification(); }} style={{ color: '#34499E', textDecoration: 'underline' }}>
           open email client
         </a>
       </p>
     ...
     <div className="navigation">
       <button onClick={goToSystemOverview} className="secondary">
         <svg style={{ width: '16px', height: '16px' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
 ...
 <div className="modal-overlay" id="galleryModal" onClick={closeGalleryOutside}>
  ...
  <div className="modal-overlay recent-modal" id="recentModal" onClick="closeGalleryOutside(event)">
    <div className="modal-content">
      <div className="modal-header">
        <h3>RECENT PROJECTS</h3>
        <button className="modal-close" onClick="closeRecentModal()">
  ...
  <div className="modal-overlay" id="sampleModal" onClick="closeGalleryOutside(event)">
    <div className="modal-content" style="max-width: 600px;">
      <div className="modal-header">
        <h3>REQUEST MATERIAL SAMPLES</h3>
        <button className="modal-close" onClick="closeSampleModal()">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <line x1="18" y1="6" x2="6" y2="18"></line>
            <line x1="6" y1="6" x2="18" y2="18"></line>
          </svg>
      ...
      <form className="sample-form" id="sampleForm" onSubmit="event.preventDefault(); submitSampleRequest();">
        <div className="form-group">
        ...
        <div className="navigation">
          <button type="button" onClick={closeSampleModal} className="secondary">Cancel</button>
